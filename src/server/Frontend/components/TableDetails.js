...
function TableDetails({status,handleSubmit,name,phone,req,setName,setPhone,setReq,errors}) {
      ...
      <form style={{ border: '1px solid black', padding: '60px', borderRadius: '10px'}} onSubmit={handleSubmit}>
        <div className='row res-row'>
          <div className='col-md-6 p-3'>
            <input type='text' name='name' onChange={namefun} placeholder='Enter your name' className='nameInput'></input>
          </div>
          <div className='col-md-6 p-3'>
